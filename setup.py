...
setup(
    ...
    install_requires=["pytest>=4", "pandas>=1", "PyYAML>=5.3", "scikit-learn>=0.23", "gensim>=3.8", "matplotlib>=3.1", "editdistance==0.5.3",
                      "regex", "tzlocal", "airr>=1", "pystache==0.5.4", "torch>=1.5.1", "numpy>=1.18", "h5py>=2.9.0", "dill>=0.3", "tqdm>=0.24", # Note: h5py v3 does not work with DeepRC, but works with everything else
