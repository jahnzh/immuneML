...
# 
#     def _encode_and_cache(self, dataset, params: EncoderParams):
#         with open("/doctorai/caters/full_encoded_dataset_immunoHUB.pkl", "rb") as f:
...
#         return full_encoded_dataset
# 
#     def get_embeddings_by_example_ids(self, full_encoded_dataset, current_index_ids):
#         relevant_embeddings = []
...
#         relevant_embeddings_list = self.get_embeddings_by_example_ids(full_encoded_dataset, current_index_ids)
#         relevant_embeddings = np.array(relevant_embeddings_list)
